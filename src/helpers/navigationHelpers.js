...
export const navigate = navigationConfig => {
  navigatorRef.dispatch(NavigationActions.navigate(navigationConfig));
};

// Not working
export const replace = navigationConfig => {
  navigatorRef.dispatch(StackActions.replace(navigationConfig));
};

export const push = navigationConfig => {
  navigatorRef.dispatch(StackActions.push(navigationConfig));
};
...
export const resetNavStack = resetConfig => {
  navigatorRef.dispatch(StackActions.reset(resetConfig));
};
